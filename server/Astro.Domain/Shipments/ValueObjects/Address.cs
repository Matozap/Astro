...
/// <summary>
/// Value object representing a shipping address (origin or destination).
/// </summary>
public sealed record Address : ValueObject
{
    ...
    private Address(string street, string city, string state, string postalCode, string country, string? contactName, string? contactPhone)
    {
        Street = street;
        City = city;
        State = state;
    ...
    protected override void Validate()
    {
        ...
        if (ContactPhone?.Length > 50)
            throw new ArgumentException("Contact phone cannot exceed 50 characters.", nameof(ContactPhone));
    }
